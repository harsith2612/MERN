        ...
        <div className="flex min-h-screen items-center justify-center">
          <div className="w-1/2 space-y-6 px-4 py-10 shadow-2xl lg:w-1/3">
            <div className="flex justify-center">
              <h1 className="text-xl font-bold text-slate-600">Login</h1>
            </div>
            <div className="flex items-center space-x-2">
              <input
                type="text"
                className="w-full rounded-lg border-2 p-2 text-sm outline-sky-500"
            ...
            <div className="space-y-2">
              <button
                type="submit"
                className="w-full rounded-md border-2 border-sky-500 bg-sky-500 py-1.5 text-sm font-bold text-white"
                onClick={(e) => onLogin(e)}
              >
                Login
              </button>
